...
let Errors = {
	MISSING_TIMESPENT: new KeyMissingOrInvalidTypeError(30, "TimeSpent"),
	MISSING_DESCRIPTION: new KeyMissingOrInvalidTypeError(31, "Description"),

	OUT_OF_RANGE_TIMESPENT: new ValidationError(32, `TimeSpent must be between ${MIN_TIMESPENT} and ${MAX_TIMESPENT}`),
};
