...
let Errors = {
	MISSING_IMPORTANCE: new KeyMissingOrInvalidTypeError(50, "Importance"),
	MISSING_DESCRIPTION: new KeyMissingOrInvalidTypeError(51, "Description"),

	OUT_OF_RANGE_IMPORTANCE: new ValidationError(52, `Importance must be between ${MIN_IMPORTANCE} and ${MAX_IMPORTANCE}`),
};
